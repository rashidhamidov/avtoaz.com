...
<head>
    ...
    <link rel="stylesheet" href="/assets/admin/css/bootstrap-datepicker3.min.css" />
    <link rel="stylesheet" href="/assets/admin/css/ui.jqgrid.min.css" />
...
<body class="no-skin">
@include('admin._static._navbar')
<div class="main-container ace-save-state" id="main-container">
    <script type="text/javascript">
        try{ace.settings.loadState('main-container')}catch(e){}
    </script>
    @include('admin._static._sidebar')
    @yield('content')

    @include('admin._static._footer')
</div>
